...
class HelloRequest(google___protobuf___message___Message):
    ...
    spaninfo = ... # type: typing___Text

    def __init__(self,
        name : typing___Optional[typing___Text] = None,
        spaninfo : typing___Optional[typing___Text] = None,
        ) -> None: ...
    @classmethod
    ...
    if sys.version_info >= (3,):
        def ClearField(self, field_name: typing_extensions___Literal[u"name",u"spaninfo"]) -> None: ...
    else:
        def ClearField(self, field_name: typing_extensions___Literal[b"name",b"spaninfo"]) -> None: ...
